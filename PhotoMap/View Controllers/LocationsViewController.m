...
static NSString * const clientID = @"ZU4FWPTDVTZ1FDBWNM5ONKHWPLYKB2VLCWGLSWZ5XWPUOXEH";
static NSString * const clientSecret = @"HPK5SDDK3TTENTG2A3NMPKBKYYP44ZAGTUNPXUZTFO5CIKK2";
...
- (void)viewDidLoad {
    ...
    [self fetchLocationsWithQuery:@"" nearCity:@""];
}
